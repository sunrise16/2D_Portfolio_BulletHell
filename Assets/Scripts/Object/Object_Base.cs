...
{
    #region VARIABLE
    private GameObject pGameObject = null;
    private Transform pTransform = null;

    private Vector3 vTempPosition = Vector3.zero;
    private Vector3 vTempLocalPosition = Vector3.zero;
    private Vector3 vTempRotation = Vector3.zero;
    private Vector3 vTempLocalRotation = Vector3.zero;
    private Vector3 vTempScale = Vector3.zero;

    private EObjectType enObjectType = EObjectType.Max;
    private int iUniqueNumber = 0;
    private string szUniqueString = "";
    ...
    public EObjectType GetObjectType() { return enObjectType; }
    ...
    public void SetObjectType() { enObjectType = EObjectType.None; }
    public void SetObjectType(EObjectType enObjectType) { this.enObjectType = enObjectType; }
    ...
    public virtual void Init(GameObject pObject, Transform pTransform, Vector3 vPosition, Vector3 vRotation, Vector3 vScale, string szObjectTag, EObjectType enObjectType)
    {
        ...
        SetObjectType(enObjectType);
        SetUniqueNumber();
        SetUniqueString(szObjectTag);
        SetVisible(true);
    }
